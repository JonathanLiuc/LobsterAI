...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    contextWindowHint: '模型最大上下文 Token 数，用于显示用量进度',
    maxTokens: '最大输出 Token',
    maxTokensPlaceholder: '如 8192',
    maxTokensHint: '单次请求允许模型输出的最大 Token 数',
  ...
  en: {
    ...
    contextWindowHint: 'Max context tokens for the model, used to show usage progress',
    maxTokens: 'Max Output Tokens',
    maxTokensPlaceholder: 'e.g. 8192',
    maxTokensHint: 'Maximum tokens the model can output per request',
