...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    contextWindowPlaceholder: '如：200000（token 数量）',
    contextWindowHint: '模型支持的最大上下文长度（token 数），用于计算上下文用量百分比',
    maxTokens: '最大输出 Token',
    maxTokensPlaceholder: '如：8192',
    maxTokensHint: '每次请求模型输出的最大 token 数量',
  ...
  en: {
    ...
    contextWindowPlaceholder: 'e.g. 200000 (tokens)',
    contextWindowHint: 'Maximum context length the model supports (in tokens), used to calculate usage percentage',
    maxTokens: 'Max Output Tokens',
    maxTokensPlaceholder: 'e.g. 8192',
    maxTokensHint: 'Maximum number of tokens the model will generate per request',
